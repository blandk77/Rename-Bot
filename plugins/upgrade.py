...
Contact @TGguy_Ownerobot before payment 

After Payment Send Screenshots Of Payment To Admin @TGguy_Ownerobot"""
    
    keybord = InlineKeyboardMarkup([
        [InlineKeyboardButton("🦋 Admin", url = "https://telegram.me/TGguy_Ownerobot"),
